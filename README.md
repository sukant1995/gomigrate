...
[![GoDoc](https://pkg.go.dev/badge/github.com/golang-migrate/migrate)](https://pkg.go.dev/github.com/sukant1995/gomigrate)
...
import (
    ...
    _ "github.com/sukant1995/gomigrate/source/github"
)
...
import (
    ...
    _ "github.com/lib/pq"
    "github.com/sukant1995/gomigrate"
    "github.com/sukant1995/gomigrate/database/postgres"
...
--------|------------|--------|------
**master** | :white_check_mark: | `import "github.com/sukant1995/gomigrate"` | New features and bug fixes arrive here first |
**v4** | :white_check_mark: | `import "github.com/sukant1995/gomigrate"` | Used for stable releases |
